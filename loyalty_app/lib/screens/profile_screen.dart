      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage("assets/images/profile.jpg"), // Update with actual image path
            ),
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  _buildProfileOption(Icons.logout, "Log Out"), // Logout Button
                ],
              ),
            ),
          ],
          ...
          ListTile(
            ...
            onTap: () {
              if (title == "Log Out") {
                ...
                print("$title tapped"); // Add navigation logic for each option
              }
            },
          ),
